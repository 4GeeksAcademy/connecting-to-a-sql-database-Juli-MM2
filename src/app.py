...
con = psycopg2.connect(host = "localhost", user = "gitpod", password = "postgres", database = "juli_database")

# 2) Execute the SQL sentences to create your tables:
...
# 3) Execute the SQL sentences to insert your data:
